...
<br />
<br />
<form action="<?php print $GLOBALS['base_url'] ?>/user?<?php print drupal_get_destination() ?>" method="post" id="user-login-form">
...
<br />
<span class="login-box-options"><a href="<?php print $GLOBALS['base_url'] ?>/user/password" title="Olvido su contrasena">Olvido su contraseña</a></span>
<br />
<br />
